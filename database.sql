...
VALUES ('Beaujolais de Damien', 'Rouge', 'Beaujolais', 1989, 10, 1),
('Saint Joseph de Damien', 'Rouge', 'Vallée du Rhône', 2018, 18, 1),
('Pommard de Damien', 'Rouge', 'Bourguogne', 2015, 38, 1),
('Nuit Saint George de Damien', 'Rouge', 'Bourguogne', 2018, 18, 1),
('Mercurey', 'Rouge', 'Bourgogne', 2018, 18, 1),
('Romanée-Conti de Damien', 'Rouge', 'Bourgogne', 1995, 10, 1),
('La villageoise de Allan', 'Blanc', 'Auvergne', 2023, 2, 2),
('Jurançon', 'Rouge', 'Jura', 2010, 6, 2),
('Côtes de Bordeaux', 'Rouge', 'Bordeaux', 2016, 9, 2),
('Pinot Blanc', 'Blanc', 'Jura', 2018, 7, 2),
('Pinot Noir', 'Rouge', 'Jura', 2019, 8, 2),
('Rosé de Lila ', 'Rosé', "Provence-Alpes-Côte-d'Azur", 1987, 7, 3),
('Viré-Clessé', 'Blanc', 'Vallée de la Loire', 2006, 12, 3),
('Pouilly-Fussé', 'Blanc', 'Bourgogne', 2001, 24, 3),
('Côtes de Provence', 'Rosé', "Provence-Alpes-Côte-d'Azur", 2012, 14, 3),
('Riesling', 'Blanc', 'Alsace', 1971 , 10, 3),
('Viognier de Mathieu', 'Blanc', 'Vallée du Rhône', 1994, 12, 4),
('Languedoc', 'Rosé', 'Languedoc', 1998, 7, 4),
('Crozes-Hermitage', 'Rouge', "Drôme", 2002, 14, 4),
('Saint-Emilion', 'Rouge', 'Bordeaux', 2000, 18, 4),
('Saint-Julien', 'Rouge', 'Bordeaux', 2007, 16, 4),
('Bordeaux de Jesse', 'Rouge', 'Bordeaux', 1995, 11, 5),
('Pommard', 'Blanc', 'Bourgogne', 2020, 12, 5),
('Mercurey', 'Rouge', 'Beaujolais', 2019, 15, 5),
('Côte du Rhône', 'Rouge', 'Vallée du Rhône', 2017, 10, 5),
('Vin de Savoie', 'Blanc', 'Savoie', 2015, 12, 5);
